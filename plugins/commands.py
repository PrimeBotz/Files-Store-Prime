...
async def start(client, message):
    ...
    "ғɪʀꜱᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ '✇ ᴊᴏɪɴ ᴏᴜʀ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ✇' ʙᴜᴛᴛᴏɴ, ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ 'ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ' ʙᴜᴛᴛᴏɴ.\n\n"
    "ᴀғᴛᴇʀ ᴛʜᴀᴛ, ᴄᴏᴍᴇ ʙᴀᴄᴋ ʜᴇʀᴇ ᴀɴᴅ ᴄʟɪᴄᴋ ᴏɴ 'ᴛʀʏ ᴀɢᴀɪɴ' ᴛᴏ sᴇɴᴅ ʏᴏᴜʀ ғɪʟᴇ. 😇</b>"
                        )
